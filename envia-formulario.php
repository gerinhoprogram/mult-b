...
<body>
	<?php
		...
		$sql = "INSERT INTO cadastro_contato (contato_email, contato_nome, contato_telefone, contato_empresa, contato_data) VALUES (:contato_email, :contato_nome, :contato_telefone, :contato_empresa, :contato_data)";
		...
		if ($enviado) {
			...
			<body>
				<main class='texto'>
					...
					<p>Acesse o link: <a href='https://youtu.be/uTuQCU0AWMM' target='_blank'>MULTIB & VAREJO - SEMPRE JUNTOS</a></p>
				</main>
			</body>
			";
